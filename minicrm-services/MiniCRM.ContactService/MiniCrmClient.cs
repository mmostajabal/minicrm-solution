...
namespace MiniCRM.ContactService;

/// <summary>
/// Base HTTP client that authenticates against the miniCRM REST API
/// using Basic Auth (SystemId:APIKey). Shared by all service projects
/// (each service embeds its own copy to stay independently deployable).
/// </summary>
